...
export default function Home() {
    return (
        ...
        <HomeDiv>
            ...
            <Top>
        <GameDescription>
Hey! Fair warning this app has spooky elements. Creepy audio clips, problem solving 👻, and puzzles. The goal is the search the channels to find the secret rooms! There are clues scattered throughout the rooms!
        </GameDescription>
            </Top>
            <Bottom>
                <NavLink to="/Game">Begin!</NavLink>
            </Bottom>
        </HomeDiv>
        </div>
    )
